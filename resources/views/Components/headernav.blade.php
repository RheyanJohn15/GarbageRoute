              ...
              <div class="quick-actions-scroll scrollbar-outer">
                <div class="quick-actions-items">
                  <div class="row m-0">
                    ...
                    <a class="col-6 col-md-4 p-0" href="/truckdriver">
                      <div class="quick-actions-item">
                    ...
                    <a class="col-6 col-md-4 p-0" href="/complaints">
                      <div class="quick-actions-item">
                        <div
          ...
          <li class="nav-item topbar-user dropdown hidden-caret">
            ...
            >
              ...
              <span class="profile-username">
                ...
                <span class="fw-bold" id="adminNameHeaderNav">Loading...</span>
              </span>
            </a>
              ...
              <div class="dropdown-user-scroll scrollbar-outer">
                <li>
                  <div class="user-box">
                    ...
                    <div class="u-text">
                      <h4 id="userNameDrop">Loading....</h4>
                      <p class="text-muted" id="userType">Loading....</p>
                      <a
                        href="/profile"
